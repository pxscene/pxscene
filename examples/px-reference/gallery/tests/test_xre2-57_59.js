...
text4067 = scene.create({
   ...
   parent:view4071,
   fontUrl:"http://www.pxscene.org/examples/px-reference/fonts/XFINITYSansTT-New-Lgt.ttf",
   leading:12,
   pixelSize:24,
   alignVertical:0,
   alignHorizontal:0,
