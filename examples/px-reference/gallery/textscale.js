px.import("px:scene.1.js").then( function ready($) {
    ...
    $.create({t:"text",text:str,parent:$.root,pixelSize:small,a:1.0,textColor:white})
        .animateTo({sx:20,sy:20},5,$.animation.TWEEN_LINEAR,$.animation.OPTION_OSCILLATE,$.animation.COUNT_FOREVER);
    $.create({t:"text",text:str,parent:$.root,pixelSize:small,a:a,textColor:cyan})
    ...
    $.create({t:"text",text:str,parent:$.root,pixelSize:large,a:a,textColor:red}) 
