...
var tests = 
{
  ...
  testObj: function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      var results = [];
      results[0] = assert(giraffe != null, "object was not found by id");
      results[1] = assert(giraffe.text === "I'm a giraffe!", "Correct object was not returned for id");
      resolve(results);
  ...
  testObj2: function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      var results = [];
      results[0] = assert(elephant != null, "object was not found by id");
      results[1] = assert(elephant.text === "I'm an elephant!", "Correct object was not returned for id");
      resolve(results);
