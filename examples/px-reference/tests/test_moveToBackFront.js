  ...
  moveToBack: function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      setTimeout(function() {
        ...
        var expectedScreenshotImage = basePackageUri+"/images/screenshot_results/test_moveToBackFront_moveToBack.png";
        var results = [];
...
/*            shots.takeScreenshot(false).then(function(link){
  ...
  moveToFront: function() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        var expectedScreenshotImage = basePackageUri+"/images/screenshot_results/test_moveToBackFront_moveToFront.png";
        var results = [];
...
/*            shots.takeScreenshot(false).then(function(link){
  ...
  moveToBackNoParent: function() {
    return new Promise(function(resolve, reject) {
        ...
        var results = [];
        var expectedScreenshotImage = basePackageUri+"/images/screenshot_results/test_moveToBackFront_moveToBackNoParent.png";
        results[0] = assert(parent.getChild(0) === dolphin, "Dolphin is not in expected position.");
        results[1] = assert(parent.getChild(1) === tile1, "Tile1 is not in expected position.");
        results[2] = assert(parent.getChild(2) === tile2, "Tile2 is not in expected position.");
        results[3] = assert(parent.getChild(3) === tile3, "Tile3 is not in expected position.");
...
/*            shots.takeScreenshot(false).then(function(link){
  ...
  moveToFrontNoParent: function() {
    ...
    return new Promise(function(resolve, reject) {
        ...
        var results = [];
        var expectedScreenshotImage = basePackageUri+"/images/screenshot_results/test_moveToBackFront_moveToFrontNoParent.png";
        results[0] = assert(parent.getChild(0) === dolphin, "Dolphin is not in expected position.");
        results[1] = assert(parent.getChild(1) === tile1, "Tile1 is not in expected position.");
        results[2] = assert(parent.getChild(2) === tile2, "Tile2 is not in expected position.");
        results[3] = assert(parent.getChild(3) === tile3, "Tile3 is not in expected position.");
