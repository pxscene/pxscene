...
var tests = {
  ...
  test4: function() {
    return new Promise(function(resolve, reject) {
    var image9 = scene.create({t:"image9",parent:root, url:"http://pxscene.org/images/dolphin.jpg"});
    image9.ready.then(function()  {
      console.log("test4: image9 ready");
      var results = [];
      results.push(assert(image9.url=="http://pxscene.org/images/dolphin.jpg","url is not proper"));
      resolve(results);
    });
  });
  },
