...
var textBox = scene.create({parent:container, t:"textBox", font:fontDejaVuSans, 
...
var text = scene.create({parent:container, t:"text",font:fontDejaVuSans, x:20,y:100,w:800,h:300,textColor:0xFFFFFFFF, pixelSize:25,
              text:"Text here and there and there and there",
              clip:false}); 
...
var doScreenshotComparison = function(name, results, printScreenshotToConsole,resolve, reject) 
{
      ...
      shots.validateScreenshot(basePackageUri+"/images/screenshot_results/test_xre2-85_"+name+".png", printScreenshotToConsole).then(function(match){
