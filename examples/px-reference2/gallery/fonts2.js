...
var myFont = scene.create({t:"fontResource",url:"http://xre2-apps.cvs-a.ula.comcast.net/pxscene-samples/examples/px-reference/fonts/XFINITYSansTT-New-Bold.ttf"});
