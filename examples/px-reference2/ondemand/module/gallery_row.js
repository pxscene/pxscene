px.import({KeyCodes:"../enums/keycodes.js"}).then( function ready(imports) {
    ...
    var GalleryRow = function (scene, model, source) {
        ...
        this.removeComponents = function() {
            ...
            row.removeAll();
            bottomFocusBar.remove();
            topFocusBar.remove();
        }

        function next() {
            console.log("GalleryRow#next()");
        ...
        function previous() {
            console.log("GalleryRow#previous()");
            if (focusIndex > 0) {
                animateFrom(focusIndex);
                focusIndex = focusIndex - 1;
                animateTo(focusIndex);
        ...
        */
        ...
        this.handleKeyDown = function(keyEvent) {
            console.log("GalleryRow#handleKeyDown() - start");
            var rtnValue = -1;
            console.log("GalleryRow:handleKeyDown(" + keyEvent + "): KeyCode.LEFT=" + KeyCode.LEFT);
            switch(keyEvent) {
                case KeyCode.LEFT:
                    console.log("   GalleryRow LEFT");
                    previous();
                    rtnValue = 1;
                    break;
                case KeyCode.RIGHT:
                    console.log("   GalleryRow RIGHT");
                    next();
                    rtnValue = 1;
                    break;
                case KeyCode.UP:
                    console.log("   GalleryRow UP");
                    break;
                case KeyCode.DOWN:
                    console.log("   GalleryRow DOWN");
                    break;
            }
